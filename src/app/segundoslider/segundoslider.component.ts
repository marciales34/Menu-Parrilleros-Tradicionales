...
@Component({
  selector: 'app-segundoslider',
  standalone: true,
  imports: [],
  templateUrl: './segundoslider.component.html',
  styleUrl: './segundoslider.component.css',
})
export class SegundosliderComponent implements AfterViewInit {
  value = 0;
  trailValue = 0;
  interval = 4000;
  start: any;
  ...
  initializeTouchEvents() {
    ...
    if (this.slider) {
      this.slider.addEventListener('touchstart', (e) => {
        ...
        sliderWidth =
          this.slider!.clientWidth / (this.trails ? this.trails.length : 1);
      });
